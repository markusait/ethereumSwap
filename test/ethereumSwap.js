...
const cryptoAddress = "3GZSJ47MPBw3swTZtCTSK8XeZNPed25bf9"
...
contract("EthereumSwap", (accounts) => {
  ...
  it("deposists ether to the contract", async () => {
    ...
    const tx = await instance.depositEther(cryptoAddress,"615525", {from:accounts[0],value: oneEth})
  ...
  it("initializes Oracleize API call correctly", async () => {
    ...
    const tx = await instance.getTransaction(testBitcoinTx,cryptoAddress, {from:accounts[0],value: halfEth})
